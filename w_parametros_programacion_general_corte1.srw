HA$PBExportHeader$w_parametros_programacion_general_corte1.srw
forward
global type w_parametros_programacion_general_corte1 from window
end type
type cb_2 from commandbutton within w_parametros_programacion_general_corte1
end type
type cb_1 from commandbutton within w_parametros_programacion_general_corte1
end type
type dw_1 from datawindow within w_parametros_programacion_general_corte1
end type
type gb_1 from groupbox within w_parametros_programacion_general_corte1
end type
end forward
...
global w_parametros_programacion_general_corte1 w_parametros_programacion_general_corte1
...
on w_parametros_programacion_general_corte1.create
...
on w_parametros_programacion_general_corte1.destroy
destroy(this.cb_2)
destroy(this.cb_1)
destroy(this.dw_1)
destroy(this.gb_1)
