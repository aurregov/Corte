HA$PBExportHeader$w_buscar_agrupaciones_parametros2.srw
forward
global type w_buscar_agrupaciones_parametros2 from window
end type
type rb_2 from radiobutton within w_buscar_agrupaciones_parametros2
end type
type rb_1 from radiobutton within w_buscar_agrupaciones_parametros2
end type
type st_1 from statictext within w_buscar_agrupaciones_parametros2
end type
type rb_prioridad from radiobutton within w_buscar_agrupaciones_parametros2
end type
type rb_po from radiobutton within w_buscar_agrupaciones_parametros2
end type
type cb_limpiar from commandbutton within w_buscar_agrupaciones_parametros2
end type
type cb_cancelar from commandbutton within w_buscar_agrupaciones_parametros2
end type
type cb_aceptar from commandbutton within w_buscar_agrupaciones_parametros2
end type
type cb_buscar from commandbutton within w_buscar_agrupaciones_parametros2
end type
type dw_criterio from datawindow within w_buscar_agrupaciones_parametros2
end type
type gb_1 from groupbox within w_buscar_agrupaciones_parametros2
end type
type dw_lista from datawindow within w_buscar_agrupaciones_parametros2
end type
type gb_2 from groupbox within w_buscar_agrupaciones_parametros2
end type
end forward
...
global w_buscar_agrupaciones_parametros2 w_buscar_agrupaciones_parametros2
...
on w_buscar_agrupaciones_parametros2.create
...
on w_buscar_agrupaciones_parametros2.destroy
destroy(this.rb_2)
destroy(this.rb_1)
destroy(this.st_1)
...
IF ll_filas >= 1 THEN
	...
	lst_parametros.entero[3] = dw_lista.GetItemNumber(ll_filas,'ca_pendiente')
...
integer taborder = 20
string title = "none"
string dataobject = "dgr_lista_buscar_agrupaciones2"
