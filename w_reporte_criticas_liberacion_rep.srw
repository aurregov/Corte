HA$PBExportHeader$w_reporte_criticas_liberacion_rep.srw
forward
global type w_reporte_criticas_liberacion_rep from w_preview_de_impresion
end type
type sle_ano from singlelineedit within w_reporte_criticas_liberacion_rep
end type
type sle_semana from singlelineedit within w_reporte_criticas_liberacion_rep
end type
type st_1 from statictext within w_reporte_criticas_liberacion_rep
end type
type st_2 from statictext within w_reporte_criticas_liberacion_rep
end type
type cb_recuperar from commandbutton within w_reporte_criticas_liberacion_rep
end type
type cb_1 from commandbutton within w_reporte_criticas_liberacion_rep
end type
type st_3 from statictext within w_reporte_criticas_liberacion_rep
end type
type em_clasifica from editmask within w_reporte_criticas_liberacion_rep
end type
type st_4 from statictext within w_reporte_criticas_liberacion_rep
end type
type em_filtro from editmask within w_reporte_criticas_liberacion_rep
end type
type cb_2 from commandbutton within w_reporte_criticas_liberacion_rep
end type
type st_5 from statictext within w_reporte_criticas_liberacion_rep
end type
type st_6 from statictext within w_reporte_criticas_liberacion_rep
end type
type st_7 from statictext within w_reporte_criticas_liberacion_rep
end type
type cb_3 from commandbutton within w_reporte_criticas_liberacion_rep
end type
type st_8 from statictext within w_reporte_criticas_liberacion_rep
end type
end forward
...
integer width = 4672
integer height = 2228
string title = "Produccion a Liberar (Necesidades)"
sle_ano sle_ano
...
global w_reporte_criticas_liberacion_rep w_reporte_criticas_liberacion_rep
...
on w_reporte_criticas_liberacion_rep.create
int iCurrent
call super::create
...
on w_reporte_criticas_liberacion_rep.destroy
call super::destroy
...
type dw_reporte from w_preview_de_impresion`dw_reporte within w_reporte_criticas_liberacion_rep
integer y = 220
integer width = 4530
integer height = 1732
...
event clicked;Long	li_fab, li_lin, li_bodysize, li_talla_pt, li_linea_exp, li_fabrica_exp
...
ELSE
	li_talla_pt = 9999
END IF
luo_liberacion_x_proyeccion.of_cargar_temp_ref_liberar(usuario, li_fab, li_lin, ll_ref, ll_color_pt, li_talla_pt, li_bodysize, ii_ano, ii_semana,0, li_fabrica_exp, li_linea_exp, ls_ref_exp, ls_color_exp,0)
