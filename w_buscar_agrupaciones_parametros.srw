HA$PBExportHeader$w_buscar_agrupaciones_parametros.srw
forward
global type w_buscar_agrupaciones_parametros from window
end type
type rb_2 from radiobutton within w_buscar_agrupaciones_parametros
end type
type rb_1 from radiobutton within w_buscar_agrupaciones_parametros
end type
type st_1 from statictext within w_buscar_agrupaciones_parametros
end type
type rb_prioridad from radiobutton within w_buscar_agrupaciones_parametros
end type
type rb_po from radiobutton within w_buscar_agrupaciones_parametros
end type
type cb_limpiar from commandbutton within w_buscar_agrupaciones_parametros
end type
type cb_cancelar from commandbutton within w_buscar_agrupaciones_parametros
end type
type cb_aceptar from commandbutton within w_buscar_agrupaciones_parametros
end type
type cb_buscar from commandbutton within w_buscar_agrupaciones_parametros
end type
type dw_criterio from datawindow within w_buscar_agrupaciones_parametros
end type
type gb_1 from groupbox within w_buscar_agrupaciones_parametros
end type
type dw_lista from datawindow within w_buscar_agrupaciones_parametros
end type
type gb_2 from groupbox within w_buscar_agrupaciones_parametros
end type
end forward
...
global w_buscar_agrupaciones_parametros w_buscar_agrupaciones_parametros

type variables
String is_sql
Transaction ltr_graficos
Long 	ii_fabpt,ii_linea,ii_fab, ii_fabrica, ii_planta, ii_centro
Long il_ref,il_pedido, il_color
end variables
...
CHOOSE CASE as_feld
	...
	CASE 'modulo'
		ls_where = "( dt_pdnxmodulo.co_modulo = "+ String(dw_criterio.GetItemNumber(1,'modulo'))+")"
END CHOOSE

RETURN ls_where
end function

on w_buscar_agrupaciones_parametros.create
...
on w_buscar_agrupaciones_parametros.destroy
destroy(this.rb_2)
destroy(this.rb_1)
destroy(this.st_1)
...
ELSE
	w_buscar_agrupaciones_parametros.x = (PixelsToUnits(le_even.ScreenWidth,XPixelsToUnits!) - w_buscar_agrupaciones_parametros.width) / 2
	w_buscar_agrupaciones_parametros.y = (PixelsToUnits(le_even.ScreenHeight,YPixelsToUnits!) - w_buscar_agrupaciones_parametros.Height) / 2
END IF
...
IF ii_fabrica = -1 THEN
	Return
END IF
ii_planta = luo_constantes.of_consultar_numerico("PLANTA LIBERACION")
IF ii_planta = -1 THEN
	Return
END IF
...
dw_criterio.GetChild('modulo', ldc_modulos)

ldc_modulos.SetTransObject(SQLCA)

ldc_modulos.Retrieve(ii_fabrica, ii_planta, ii_centro)
...
integer taborder = 10
string title = "none"
string dataobject = "dff_criterio_buscar_agrupaciones"
...
integer taborder = 20
string title = "none"
string dataobject = "dgr_lista_buscar_agrupaciones"
