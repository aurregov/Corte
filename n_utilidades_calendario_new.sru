HA$PBExportHeader$n_utilidades_calendario_new.sru
forward
global type n_utilidades_calendario_new from nonvisualobject
end type
end forward

global type n_utilidades_calendario_new from nonvisualobject autoinstantiate
end type
...
on n_utilidades_calendario_new.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_utilidades_calendario_new.destroy
