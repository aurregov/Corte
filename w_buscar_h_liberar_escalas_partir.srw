HA$PBExportHeader$w_buscar_h_liberar_escalas_partir.srw
forward
global type w_buscar_h_liberar_escalas_partir from w_base_buscar_lista_parametro
end type
end forward
...
global w_buscar_h_liberar_escalas_partir w_buscar_h_liberar_escalas_partir

on w_buscar_h_liberar_escalas_partir.create
call super::create
end on

on w_buscar_h_liberar_escalas_partir.destroy
call super::destroy
end on
...
type st_1 from w_base_buscar_lista_parametro`st_1 within w_buscar_h_liberar_escalas_partir
string text = "Grupo:"
end type

type em_dato from w_base_buscar_lista_parametro`em_dato within w_buscar_h_liberar_escalas_partir
...
type st_numero_registros from w_base_buscar_lista_parametro`st_numero_registros within w_buscar_h_liberar_escalas_partir
integer x = 1074
integer y = 756
end type

type pb_cancelar from w_base_buscar_lista_parametro`pb_cancelar within w_buscar_h_liberar_escalas_partir
integer x = 1673
integer y = 876
integer taborder = 40
end type

type pb_aceptar from w_base_buscar_lista_parametro`pb_aceptar within w_buscar_h_liberar_escalas_partir
integer x = 1115
integer y = 876
integer taborder = 20
end type
...
type dw_lista from w_base_buscar_lista_parametro`dw_lista within w_buscar_h_liberar_escalas_partir
integer x = 5
integer width = 3433
integer taborder = 30
end type
