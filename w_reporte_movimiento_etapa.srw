HA$PBExportHeader$w_reporte_movimiento_etapa.srw
forward
global type w_reporte_movimiento_etapa from w_preview_de_impresion
end type
type dw_criterio from datawindow within w_reporte_movimiento_etapa
end type
type cb_recuperar from commandbutton within w_reporte_movimiento_etapa
end type
end forward
...
global w_reporte_movimiento_etapa w_reporte_movimiento_etapa

on w_reporte_movimiento_etapa.create
int iCurrent
call super::create
...
on w_reporte_movimiento_etapa.destroy
call super::destroy
...
type dw_reporte from w_preview_de_impresion`dw_reporte within w_reporte_movimiento_etapa
integer x = 37
integer y = 156
string dataobject = "dtb_movimientos_etapas"
end type
