HA$PBExportHeader$w_liquidaciones.srw
forward
global type w_liquidaciones from w_base_maestrotb_detalletb_para_tabs
end type
...
type dw_encabezado from datawindow within w_liquidaciones
end type
type dw_otros from uo_dtwndow within w_liquidaciones
end type
type dw_unidades from uo_dtwndow within w_liquidaciones
end type
end forward
...
IF is_cambios = "no" OR is_accion <> "cancelo" THEN
	OpenWithParm(w_consultar_trazos, lstr_parametros)
...
type dw_maestro from w_base_maestrotb_detalletb_para_tabs`dw_maestro within w_liquidaciones
integer y = 300
integer width = 2811
integer height = 320
integer taborder = 30
...
type tab_1 from w_base_maestrotb_detalletb_para_tabs`tab_1 within w_liquidaciones
integer x = 5
integer y = 640
integer width = 2139
integer taborder = 60
...
type dw_detalle from w_base_maestrotb_detalletb_para_tabs`dw_detalle within w_liquidaciones
integer x = 9
integer y = 876
integer width = 2853
integer height = 532
string dataobject = "dtb_rollos_liquidacion_trazos"
...
string dataobject = "dff_consulta_trazos_liquidacion"
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "dtb_unidades_liquidacion_trazos"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
