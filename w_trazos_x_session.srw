HA$PBExportHeader$w_trazos_x_session.srw
forward
global type w_trazos_x_session from window
end type
type st_lsec from statictext within w_trazos_x_session
end type
type st_2 from statictext within w_trazos_x_session
end type
type st_ltz from statictext within w_trazos_x_session
end type
type st_1 from statictext within w_trazos_x_session
end type
type cbx_retazo from checkbox within w_trazos_x_session
end type
type dw_oc from u_dw_base within w_trazos_x_session
end type
type cb_2 from commandbutton within w_trazos_x_session
end type
type dw_seccion from u_dw_base within w_trazos_x_session
end type
type dw_pdn_talla from u_dw_base within w_trazos_x_session
end type
type dw_produccion from u_dw_base within w_trazos_x_session
end type
type dw_trazo from u_dw_base within w_trazos_x_session
end type
type cb_1 from commandbutton within w_trazos_x_session
end type
type gb_1 from groupbox within w_trazos_x_session
end type
end forward
...
global w_trazos_x_session w_trazos_x_session
...
integer height = 648
integer taborder = 10
string dataobject = "d_cuadro_pdn_x_tallas_pendientes3"
boolean hscrollbar = true
boolean vscrollbar = true
end type
