HA$PBExportHeader$w_trazos_x_session2_marlon.srw
forward
global type w_trazos_x_session2_marlon from window
end type
type st_lsec from statictext within w_trazos_x_session2_marlon
end type
type st_2 from statictext within w_trazos_x_session2_marlon
end type
type st_ltz from statictext within w_trazos_x_session2_marlon
end type
type st_1 from statictext within w_trazos_x_session2_marlon
end type
type cbx_retazo from checkbox within w_trazos_x_session2_marlon
end type
type dw_oc from u_dw_base within w_trazos_x_session2_marlon
end type
type cb_2 from commandbutton within w_trazos_x_session2_marlon
end type
type dw_seccion from u_dw_base within w_trazos_x_session2_marlon
end type
type dw_pdn_talla from u_dw_base within w_trazos_x_session2_marlon
end type
type dw_produccion from u_dw_base within w_trazos_x_session2_marlon
end type
type dw_trazo from u_dw_base within w_trazos_x_session2_marlon
end type
type cb_1 from commandbutton within w_trazos_x_session2_marlon
end type
type gb_1 from groupbox within w_trazos_x_session2_marlon
end type
end forward
...
global w_trazos_x_session2_marlon w_trazos_x_session2_marlon
...
Long	li_pos_cortar, li_pos_inicial,li_return,li_trazo
	...
	IF Not IsNull(ll_ordencorte)  THEN
		...
		ELSE
			...
			FOR ll_i = 1 TO ids_trazo.RowCount()
				...
				IF isnull(li_trazo) THEN li_trazo = 0
			...
			IF isnull(ls_body) OR ls_body = '' THEN
			ELSE
				...
				lole_item.To      = "mahernan@gef.com.co"
...
Long ll_cant,ll_capa,ll_nmtlla,ll_mncp
...
on w_trazos_x_session2_marlon.create
...
on w_trazos_x_session2_marlon.destroy
