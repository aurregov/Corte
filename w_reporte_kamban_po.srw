HA$PBExportHeader$w_reporte_kamban_po.srw
forward
global type w_reporte_kamban_po from w_preview_de_impresion
end type
end forward
...
global w_reporte_kamban_po w_reporte_kamban_po

on w_reporte_kamban_po.create
call super::create
end on

on w_reporte_kamban_po.destroy
call super::destroy
...
type dw_reporte from w_preview_de_impresion`dw_reporte within w_reporte_kamban_po
integer y = 32
integer width = 3616
integer height = 1944
