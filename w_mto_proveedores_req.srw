HA$PBExportHeader$w_mto_proveedores_req.srw
forward
global type w_mto_proveedores_req from w_mto_base
end type
end forward
...
global w_mto_proveedores_req w_mto_proveedores_req

on w_mto_proveedores_req.create
call super::create
if this.MenuName = "m_mantenimiento_simple" then this.MenuID = create m_mantenimiento_simple
end on

on w_mto_proveedores_req.destroy
call super::destroy
...
type dw_1 from w_mto_base`dw_1 within w_mto_proveedores_req
integer x = 23
integer y = 20
integer width = 2258
string dataobject = "d_mto_proveedor_req"
