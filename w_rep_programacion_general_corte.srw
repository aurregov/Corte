HA$PBExportHeader$w_rep_programacion_general_corte.srw
forward
global type w_rep_programacion_general_corte from w_preview_de_impresion
end type
end forward
...
global w_rep_programacion_general_corte w_rep_programacion_general_corte
...
on w_rep_programacion_general_corte.create
call super::create
end on

on w_rep_programacion_general_corte.destroy
call super::destroy
...
type dw_reporte from w_preview_de_impresion`dw_reporte within w_rep_programacion_general_corte
integer x = 0
integer y = 8
integer width = 3397
