HA$PBExportHeader$w_mto_motodos_prog.srw
forward
global type w_mto_motodos_prog from w_mto_base
end type
end forward
...
integer width = 1253
integer height = 860
string title = "Metodos Programaci$$HEX1$$f300$$ENDHEX$$n"
string menuname = "m_mantenimiento_simple"
boolean resizable = false
end type
global w_mto_motodos_prog w_mto_motodos_prog

on w_mto_motodos_prog.create
call super::create
if this.MenuName = "m_mantenimiento_simple" then this.MenuID = create m_mantenimiento_simple
end on

on w_mto_motodos_prog.destroy
call super::destroy
...
type dw_1 from w_mto_base`dw_1 within w_mto_motodos_prog
integer x = 23
integer y = 20
integer width = 1175
string dataobject = "d_mto_metodos_prog"
