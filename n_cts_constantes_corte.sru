HA$PBExportHeader$n_cts_constantes_corte.sru
forward
global type n_cts_constantes_corte from nonvisualobject
end type
end forward

global type n_cts_constantes_corte from nonvisualobject autoinstantiate
end type
...
on n_cts_constantes_corte.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_cts_constantes_corte.destroy
