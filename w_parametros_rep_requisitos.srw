HA$PBExportHeader$w_parametros_rep_requisitos.srw
forward
global type w_parametros_rep_requisitos from window
end type
type dw_1 from datawindow within w_parametros_rep_requisitos
end type
type cb_2 from commandbutton within w_parametros_rep_requisitos
end type
type cb_1 from commandbutton within w_parametros_rep_requisitos
end type
type gb_1 from groupbox within w_parametros_rep_requisitos
end type
end forward
...
global w_parametros_rep_requisitos w_parametros_rep_requisitos
...
on w_parametros_rep_requisitos.create
...
on w_parametros_rep_requisitos.destroy
destroy(this.dw_1)
destroy(this.cb_2)
destroy(this.cb_1)
destroy(this.gb_1)
...
integer taborder = 10
string title = "none"
string dataobject = "d_parametros_rep_requisitos"
...
luo_param.il_vector[4] = dw_1.GetItemNumber(1,'estado')
