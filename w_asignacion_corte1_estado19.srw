HA$PBExportHeader$w_asignacion_corte1_estado19.srw
$PBExportComments$administraci$$HEX1$$f300$$ENDHEX$$n de asignaci$$HEX1$$f300$$ENDHEX$$n de m$$HEX1$$f300$$ENDHEX$$dulos
forward
global type w_asignacion_corte1_estado19 from w_base_maestroff_detalletb
end type
type cb_1 from commandbutton within w_asignacion_corte1_estado19
end type
type cb_2 from commandbutton within w_asignacion_corte1_estado19
end type
type cb_3 from commandbutton within w_asignacion_corte1_estado19
end type
type gb_1 from groupbox within w_asignacion_corte1_estado19
end type
type gb_2 from groupbox within w_asignacion_corte1_estado19
end type
end forward
...
global w_asignacion_corte1_estado19 w_asignacion_corte1_estado19
...
on w_asignacion_corte1_estado19.create
int iCurrent
call super::create
...
on w_asignacion_corte1_estado19.destroy
call super::destroy
...
type dw_maestro from w_base_maestroff_detalletb`dw_maestro within w_asignacion_corte1_estado19
integer x = 50
integer y = 52
integer width = 2729
integer height = 204
...
type dw_detalle from w_base_maestroff_detalletb`dw_detalle within w_asignacion_corte1_estado19
integer x = 5
integer y = 324
integer width = 3570
integer height = 1404
...
string dataobject = "dtb_dt_pdnxmodulo2_estado19"
boolean border = false
boolean hsplitscroll = false
end type
...
//		   ldc_pendiente,ll_co_est_prog_dia,li_fabexp,li_cslib,li_fabpt,li_lin,li_csest,li_cspar,li_ca_proyectada,&
//			li_ca_actual,li_ca_numerada,li_proceso,li_cs_prioridad,li_co_estado_asigna,li_co_curva,li_co_tipo_asignacion,&
...
//		   ll_area,ll_cs_observacion,ll_asignacion,ll_agrupacion, li_col
...
//					", Linea: "+ String(li_lin) + ", Referencia: "+String(ll_ref)+", Color: "+String(li_col)+&
//					", Tono: "+ls_tono
//		is_body = ls_body
//		is_llamado = 'SI'
...
Open(w_buscar_agrupaciones_parametros2)

lst_parametros = Message.PowerObjectParm

IF lst_parametros.cadena[1] <> 'NO' THEN
	ls_expresion = "cs_prioridad = " + String(lst_parametros.entero[1]) + " and co_modulo = " +String(lst_parametros.entero[2])+ " and ca_pendiente = " + String(lst_parametros.entero[3])  
