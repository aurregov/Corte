HA$PBExportHeader$w_buscar_dato_string.srw
forward
global type w_buscar_dato_string from w_buscar
end type
type dw_dato from datawindow within w_buscar_dato_string
end type
end forward
...
global w_buscar_dato_string w_buscar_dato_string
...
If ll_fila > 0 Then
	...
	lstr_parametros.cadena[2] = dw_lista.GetItemString(ll_fila,'codigo')
...
on w_buscar_dato_string.create
int iCurrent
call super::create
...
on w_buscar_dato_string.destroy
call super::destroy
...
type cb_cancelar from w_buscar`cb_cancelar within w_buscar_dato_string
end type

type cb_aceptar from w_buscar`cb_aceptar within w_buscar_dato_string
end type

type dw_lista from w_buscar`dw_lista within w_buscar_dato_string
integer x = 87
integer y = 248
integer width = 1097
integer height = 820
...
type gb_1 from w_buscar`gb_1 within w_buscar_dato_string
integer x = 59
integer y = 176
integer width = 1157
integer height = 920
