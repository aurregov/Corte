HA$PBExportHeader$w_buscar_rayasxbase2.srw
forward
global type w_buscar_rayasxbase2 from window
end type
type pb_2 from picturebutton within w_buscar_rayasxbase2
end type
type pb_1 from picturebutton within w_buscar_rayasxbase2
end type
type dw_1 from datawindow within w_buscar_rayasxbase2
end type
type gb_1 from groupbox within w_buscar_rayasxbase2
end type
end forward
...
global w_buscar_rayasxbase2 w_buscar_rayasxbase2

on w_buscar_rayasxbase2.create
...
on w_buscar_rayasxbase2.destroy
destroy(this.pb_2)
destroy(this.pb_1)
destroy(this.dw_1)
destroy(this.gb_1)
...
integer taborder = 10
string title = "none"
string dataobject = "d_buscar_raya_telaxbase"
