HA$PBExportHeader$w_reporte_liquidacion_ordencorte.srw
forward
global type w_reporte_liquidacion_ordencorte from w_preview_de_impresion
end type
end forward
...
global w_reporte_liquidacion_ordencorte w_reporte_liquidacion_ordencorte

on w_reporte_liquidacion_ordencorte.create
call super::create
end on

on w_reporte_liquidacion_ordencorte.destroy
call super::destroy
...
type dw_reporte from w_preview_de_impresion`dw_reporte within w_reporte_liquidacion_ordencorte
integer x = 14
integer width = 3753
integer height = 2244
string dataobject = "r_liquidacion_orden_corte"
end type
