HA$PBExportHeader$w_consultar_trazos.srw
forward
global type w_consultar_trazos from w_base_buscar_lista_parametro
end type
end forward
...
global w_consultar_trazos w_consultar_trazos

type variables

end variables

on w_consultar_trazos.create
call super::create
end on

on w_consultar_trazos.destroy
call super::destroy
end on

type st_1 from w_base_buscar_lista_parametro`st_1 within w_consultar_trazos
integer x = 23
integer y = 20
integer width = 279
...
type em_dato from w_base_buscar_lista_parametro`em_dato within w_consultar_trazos
integer x = 302
integer y = 20
integer width = 357
...
type st_numero_registros from w_base_buscar_lista_parametro`st_numero_registros within w_consultar_trazos
integer x = 27
integer y = 956
end type

type pb_cancelar from w_base_buscar_lista_parametro`pb_cancelar within w_consultar_trazos
integer x = 2505
integer y = 924
end type

type pb_aceptar from w_base_buscar_lista_parametro`pb_aceptar within w_consultar_trazos
integer x = 2112
integer y = 924
...
type dw_lista from w_base_buscar_lista_parametro`dw_lista within w_consultar_trazos
integer x = 23
integer y = 116
integer width = 3365
integer height = 788
string dataobject = "dtb_consulta_trazos_liquidacion"
