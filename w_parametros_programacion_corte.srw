HA$PBExportHeader$w_parametros_programacion_corte.srw
forward
global type w_parametros_programacion_corte from window
end type
type dw_1 from datawindow within w_parametros_programacion_corte
end type
type cb_2 from commandbutton within w_parametros_programacion_corte
end type
type cb_1 from commandbutton within w_parametros_programacion_corte
end type
type gb_1 from groupbox within w_parametros_programacion_corte
end type
end forward
...
global w_parametros_programacion_corte w_parametros_programacion_corte
...
on w_parametros_programacion_corte.create
...
on w_parametros_programacion_corte.destroy
destroy(this.dw_1)
destroy(this.cb_2)
destroy(this.cb_1)
destroy(this.gb_1)
...
integer taborder = 10
string title = "none"
string dataobject = "d_parametros_programacion_corte"
