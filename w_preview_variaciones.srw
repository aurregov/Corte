HA$PBExportHeader$w_preview_variaciones.srw
forward
global type w_preview_variaciones from w_preview_de_impresion
end type
type st_1 from statictext within w_preview_variaciones
end type
end forward
...
global w_preview_variaciones w_preview_variaciones

on w_preview_variaciones.create
int iCurrent
call super::create
...
on w_preview_variaciones.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.st_1)
end on

event open;LONG 					ll_cs_ordenpd_pt,ll_color_pt,ll_raya
...
type dw_reporte from w_preview_de_impresion`dw_reporte within w_preview_variaciones
integer x = 14
integer width = 3913
string dataobject = "dtb_reporte_variaciones_corte"
end type
