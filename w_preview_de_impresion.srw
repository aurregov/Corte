HA$PBExportHeader$w_preview_de_impresion.srw
forward
global type w_preview_de_impresion from window
end type
type dw_reporte from datawindow within w_preview_de_impresion
end type
end forward
...
global w_preview_de_impresion w_preview_de_impresion
