...
integer width = 3675
integer height = 2056
string title = "Asignaci$$HEX1$$f300$$ENDHEX$$n a M$$HEX1$$f300$$ENDHEX$$dulos"
...
global w_asignacion_modulos w_asignacion_modulos
...
event ue_parametros;Long 					ll_fila
...
type dw_maestro from w_base_maestroff_detalletb`dw_maestro within w_asignacion_modulos
integer x = 5
integer y = 8
integer width = 3589
integer height = 336
string title = "Maestro de m$$HEX1$$f300$$ENDHEX$$dulos"
string dataobject = "dff_modulos_de_asignacion"
...
type dw_detalle from w_base_maestroff_detalletb`dw_detalle within w_asignacion_modulos
integer x = 5
integer y = 332
integer width = 3589
integer height = 1480
